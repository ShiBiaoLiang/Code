...
<tr>
   ...
   <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=loan%>">元</td>
</tr>
  <tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>年数</b></font></label></td>
    <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=deadline %>">年</td>
  </tr>
   <tr>
...
<tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>复利总值:</b></font></label></td>
   <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=amount %>"></td>
</tr>


 <tr>
  <td><font size=6><a href="fuli_calculator.jsp">重新计算</a></font></td>
   </tr>
   </table>
</form>
  </body>
