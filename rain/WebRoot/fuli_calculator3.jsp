...
<html>
  <head>
    ...
    <title>My JSP 'fuli_calculator3.jsp' starting page</title>
...
<body>
<form action="FuLi3.jsp" class="form-horizontal" id="content">
	<table class="table">
...
<tr>
  ...
  <tr>
   ...
   <td> <input type="text" class="control" id="exampleInputPassword2" name="amount"><font size=5>元
   </font></td>
</tr>

 <tr>
  <td><button type="submit" class="btn btn-large btn-primary">开始计算</button></td>
  <td> <button type="reset" class="btn btn-default btn-large btn-primary">重新计算</button></td>
   </tr>
   </table>
</form>
</body>
