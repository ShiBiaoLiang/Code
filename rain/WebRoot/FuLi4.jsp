...
<html>
  <head>
    ...
    <title>My JSP 'FuLi4.jsp' starting page</title>
  ...
  <% 
       ...
       double year_rate = Math.pow(amount / loan, 1.0 / deadline) - 1;
	...
	<nav class="navbar navbar-default"  style=" margin-bottom: 0px;">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="fuli_calculator.jsp">复利存款</a>
		</div>
...
<form  class="form-horizontal" id="content">
	...
	<td style="color:#FF6600;"><font size=5> <b>计算</b> <font size=6> 利率</font> </font></td>
<tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>本金:</b></font></label></td>
   <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=loan %>"><font size=5>元
   </font></td>
</tr>
  <tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>预期金额:</b></font></label></td>
    <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=amount%>"><font size=5>元
   </font></td>
  </tr>
   <tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>年限:</b></font></label></td>
   <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=deadline %>"><font size=5>年
   </font></td>
</tr>
<tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>利率为:</b></font></label></td>
   <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=year_rate%>"></td>
</tr>
 <tr>
  <td><font size=6><a href="fuli_calculator4.jsp">重新计算</a></font></td>
