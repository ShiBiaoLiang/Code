...
<html>
  <head>
    ...
    <title>My JSP 'FuLi3.jsp' starting page</title>
  ...
  <% 
       ...
       double deadline = Math.log(amount / loan) / Math.log(1 + year_rate);
...
<body>
<form action="ComInterest3.jsp" class="form-horizontal" id="content">
	<table class="table">
	
	<td style="color:#FF6600;"><font size=5> <b>计算</b> <font size=6> 年限</font> </font></td>
<tr>
...
<tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>需要时间为</b></font></label></td>
   <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=deadline%>"><font size=5>年
   </font></td>
</tr>
 <tr>
  <td><font size=6><a href="fuli_calculator3.jsp">重新计算</a></font></td>
   </tr>
   </table>
</form>
</body>
