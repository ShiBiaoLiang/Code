...
<html>
  <head>
    ...
    <title>My JSP 'fuli_calculator1.jsp' starting page</title>
...
<body>
<form action="FuLi1.jsp" class="form-horizontal" id="content">
	<table class="table">
	
	<tr>
	<td style="color:#FF6600;"><font size=5> <b>单利</b> <font size=6> 计算</td>
	</tr>
<tr>
  ...
  <tr>
   <td> <label for="inputtext3 control-label"><font size=5> <b>年数</b></font></label></td>
    <td> <input type="text" class="control" id="exampleInputPassword2" name="deadline"><font size=5> <b>年</b></font></td>
  </tr>
   <tr>
